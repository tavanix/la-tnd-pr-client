...
const CustomTooltip = ({ active, payload }) => {
  if (active && payload && payload.length) {
    return (
      <div className='custom-tooltip w-full h-8 p-2 flex items-center justify-center rounded-xl'>
        <p>
...
function ChartTreeMap({ title, data }) {
  return (
    <div className='rounded-[7px] h-[480px] w-1/2 flex flex-col items-center border shadow-lg'>
