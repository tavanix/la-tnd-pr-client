const ChartBudget = ({
  ...
  return (
    <div className='rounded-[16px] h-[244px] w-full flex flex-col items-center border shadow-lg p-6 bg-white'>
      <div className='h-screen w-full flex gap-6'>
        {/* Бюджет */}
        <div className='p-6 shadow rounded-2xl transform transition duration-500 hover:scale-105 w-1/3 flex items-center justify-center h-auto bg-[#fff]'>
